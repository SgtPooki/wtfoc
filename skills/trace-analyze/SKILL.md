---
name: trace-analyze
description: Trace a question across sources and synthesize an analysis using a wtfoc collection
allowed-tools: Bash, Read
metadata:
  short-description: Cross-source trace and analysis with wtfoc
---
