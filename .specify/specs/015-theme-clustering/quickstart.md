...
2. Checks for existing cluster state at `~/.wtfoc/clusters/{collection}/`
...
6. Enriches clusters with exemplar chunks, top terms (TF-IDF), source distribution, signal aggregates
