...
# All agents share AGENTS.md in this project — single source of truth.
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
CLAUDE_FILE="$AGENTS_FILE"
GEMINI_FILE="$AGENTS_FILE"
COPILOT_FILE="$AGENTS_FILE"
CURSOR_FILE="$AGENTS_FILE"
QWEN_FILE="$AGENTS_FILE"
WINDSURF_FILE="$AGENTS_FILE"
KILOCODE_FILE="$AGENTS_FILE"
AUGGIE_FILE="$AGENTS_FILE"
ROO_FILE="$AGENTS_FILE"
CODEBUDDY_FILE="$AGENTS_FILE"
QODER_FILE="$AGENTS_FILE"
AMP_FILE="$AGENTS_FILE"
SHAI_FILE="$AGENTS_FILE"
TABNINE_FILE="$AGENTS_FILE"
KIRO_FILE="$AGENTS_FILE"
AGY_FILE="$AGENTS_FILE"
BOB_FILE="$AGENTS_FILE"
VIBE_FILE="$AGENTS_FILE"
KIMI_FILE="$AGENTS_FILE"
TRAE_FILE="$AGENTS_FILE"
IFLOW_FILE="$AGENTS_FILE"
