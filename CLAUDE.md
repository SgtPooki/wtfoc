...
<!-- SW:SECTION:header version="1.0.571" -->
**Framework**: SpecWeave | **Truth**: `spec.md` + `tasks.md`

**Baseline rules**: [`AGENTS.md`](AGENTS.md) defines project-wide operating rules (style, seams, commit discipline, edit checklist). All agents — including Claude — MUST follow AGENTS.md as the foundation. This file adds specweave-specific workflow on top.
<!-- SW:END:header -->

<!-- SW:SECTION:claude-code-concepts version="1.0.571" -->
## Skills & Plugins
...
<!-- SW:SECTION:autodetect version="1.0.571" -->
## Auto-Detection
...
<!-- SW:SECTION:metarule version="1.0.571" -->
...
- Run tests and lint after every task: `pnpm test` + `pnpm lint:fix`
...
<!-- SW:SECTION:rules version="1.0.571" -->
## Rules
...
<!-- SW:SECTION:workflow version="1.0.571" -->
## Workflow
...
<!-- SW:SECTION:save-nested-repos version="1.0.571" -->
## Nested Repos
...
<!-- SW:SECTION:reflect version="1.0.571" -->
## Skill Memories
...
<!-- SW:SECTION:context version="1.0.571" -->
## Context
...
<!-- SW:SECTION:structure version="1.0.571" -->
## Structure
...
<!-- SW:SECTION:taskformat version="1.0.571" -->
## Task Format
...
<!-- SW:SECTION:tdd version="1.0.571" -->
## TDD
...
<!-- SW:SECTION:api version="1.0.571" -->
<!-- API: Enable `apiDocs` in config.json. Commands: /sw:api-docs -->
<!-- SW:END:api -->

<!-- SW:SECTION:limits version="1.0.571" -->
## Limits

**Max 1500 lines/file** — extract before adding
<!-- SW:END:limits -->

<!-- SW:SECTION:troubleshooting version="1.0.571" -->
## Troubleshooting
...
<!-- SW:SECTION:lazyloading version="1.0.571" -->
## Plugin Auto-Loading
...
<!-- SW:SECTION:principles version="1.0.571" -->
## Principles
...
<!-- SW:SECTION:linking version="1.0.571" -->
...
<!-- SW:SECTION:docs version="1.0.571" -->
## Docs

[verified-skill.com](https://verified-skill.com)
<!-- SW:END:docs -->

<!-- SW:SECTION:non-claude version="1.0.571" -->
