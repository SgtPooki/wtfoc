...
**Learn more:** [Why wtfoc?](docs/why.md) | [Evidence layer for RAG](docs/evidence-layer.md) | [Querying guide](docs/querying-guide.md) | [Vision & North-Star Goals](docs/vision.md) | [Pipeline Architecture](docs/pipeline-architecture.md)
