...
import { getKnob, KNOBS, knobsToPromptLines, validateProposal } from "./knobs.js";
...
describe("validateProposal", () => {
	...
	it("rejects float outside range", () => {
		...
		expect(validateProposal("traceMinScore", 0.7)).toMatch(/outside/);
	});

	it("accepts enum value in set", () => {
